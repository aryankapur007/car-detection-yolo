...
st.write(f"Image ID: {image}")


# Display the selected image
st.image(img_path, caption='Random Image', use_column_width=True)
...
st.image('C:/cogentinfo/yolo-learning/yolov5/runs/detect/exp/vid_5_400.jpg', caption='Detected Image 2', use_column_width=True)
st.image('C:/cogentinfo/yolo-learning/yolov5/runs/detect/exp/vid_5_26740.jpg', caption='Detected Image 3', use_column_width=True)